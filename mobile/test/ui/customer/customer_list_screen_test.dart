...
void main() {
  testWidgets('CustomerListScreen shows empty state', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('CustomerListScreen shows list of customers', (
    WidgetTester tester,
  ) async {
    final customerRepo = MockCustomerRepository(
      initialCustomers: [
  ...
  testWidgets('CustomerListScreen shows error state and retry button', (
    WidgetTester tester,
  ) async {
